...
class Solution:
    def romanToInt(self, s: str) -> int:
        ...
        map1 = {"I": 1, "V": 5, "X": 10, "L": 50,
                "C": 100, "D": 500, "M": 1000}
        map2 = {"II": 2, "IV": 4, "IX": 9, "XL": 40,
                "XC": 90, "CD": 400, "CM": 900}
...
class Solution:
    def romanToInt(self, s: str) -> int:
        ...
        idx = 0
        while idx < len(s):
            if idx + 1 < len(s) and symToVal[s[idx+1]] > symToVal[s[idx]]:
                res += symToVal[s[idx+1]] - symToVal[s[idx]]
                idx += 2
            else:
                res += symToVal[s[idx]]
                idx += 1
